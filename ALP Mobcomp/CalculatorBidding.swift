    ...
    var body: some View {
        ZStack{
            ...
            Text("SCORE")
              ...
              .position(CGPoint(x: widthLayar * 0.5, y: heightLayar * 0.012))
            ...
            Text("SUBMIT")
              ...
              .multilineTextAlignment(.center)
              .foregroundColor(Color(red: 0.14, green: 1, blue: 0))
              .frame(width: 150, height: 70, alignment: .center)
              .position(CGPoint(x: widthLayar * 0.85, y: heightLayar * 0.012))
