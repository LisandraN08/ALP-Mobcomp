                    ...
                    ZStack() {
                        ...
                        NavigationLink(destination: BiddingView(), isActive: $isBiddingViewActive) {
                            Button(action: {
                                ...
                                ZStack {
                                    Image(isLightMode ? "Rectangle 294" : "Rectangle 294-2")
                                        .position(CGPoint(x: widthLayar * 0.47, y: heightLayar * 0.4))
                                    ...
                                    Rectangle()
                                      ...
                                      .position(CGPoint(x: widthLayar * 0.65, y: heightLayar * 0.39))
                                    ...
                                    Text("Bidding")
                                      ...
                                      .multilineTextAlignment(.center)
                                      .foregroundColor(isLightMode ? .black : .white)
                                      .position(CGPoint(x: widthLayar * 0.25, y: heightLayar * 0.39))
                        ...
                        Button(action: {
                            ...
                            .position(CGPoint(x: widthLayar * 0.45, y: heightLayar * 0.65))
                        }
                        .buttonStyle(PlainButtonStyle()) // Untuk menghilangkan default button style
                    }
